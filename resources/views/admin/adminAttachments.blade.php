                ...
                <div class="grid">
                    ...
                    <div class="flex justify-start items-center gap-4 pt-5 pl-8">
                        <form action="{{
                         ...
                         <a href="{{ route('admin.create') }}" class="no-underline text-white text py-2 px-3 rounded-lg bg-blue-500 hover:no-underline hover:bg-blue-700">CREATE NEW FILE</a>
                       ...
                       {{-- @if (request()->route()->getName() == "admin.public" || request()->route()->getName() == "admin.attachments") --}}
