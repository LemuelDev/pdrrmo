...
@section('content')
    <section class="min-h-[100vh] w-full flex items-start">
        ...
        <div class="flex-grow px-10 pt-8 h-auto border-solid">
            ...
            <div class="pt-4 pl-8">
                <h4 class="text-2xl font-bold py-2 ">ADMIN PROFILE</h4>
            ...
            <div class=" grid content-center px-8">
                @if ($editing ?? false)
                    <form action="{{route('admin.update', auth()->user()->userProfile->id)}}" method="post" class="grid grid-cols-2 gap-8 px-12 pt-8" enctype="multipart/form-data">
                         @csrf
                         @method('put')
                        <div class="grid">
                        ...
                        <div class="grid">
                         ...
                         <div class="flex justify-around gap-4">
                            <a href="{{route('admin.showRequest')}}" class="pt-3 text-lg px-7 mt-10  text-center border-r-full border-none bg-purple-500 hover:bg-purple-600 text-white rounded-lg max-h-[55px] max-w-[280px]">Transfer of Municipality</a>
                            <a href="{{route('admin.password', ['user' => auth()->user()->id])}}" class="pt-3 text-lg px-7 mt-10 text-center border-r-full border-none bg-gray-600 hover:bg-gray-700 text-white rounded-lg max-h-[55px] max-w-[220px]">Update Password</a>
                        </div>
