...
<section class="flex items-center justify-center w-full h-full py-4">
    <div class="grid grid-cols-1 md:grid-cols-2  max-w-[1100px]  h-[650px] m-auto p-6 pt-24 max-md:pt-24 max-sm:pt-12">
        ...
        <form action="{{route('password.email')}}" method="post" class="grid content-center gap-5 py-14 px-12 shadow-2xl rounded-xl max-md:px-6 max-md:py-6">
            ...
            <input type="text" name="email" id="email" placeholder="Enter email..." class="py-3 pt-2 px-6 bor-r-8 bg-slate-100 border-black outline-green-500 w-full">
