 ...
 <div class="pt-4 pl-8">
    ...
    <form action="{{route('admin.update-staff', $staff->userProfile->id)}}" method="post" class="grid grid-cols-2 gap-8 px-12 pt-8">
        ...
        <div class="grid">
            ...
            <input type="text" name="username" readonly id="username" value="{{$staff->userProfile->name}}"placeholder="Username..." class="py-3 px-6 rounded-lg shadow-xl bg-slate-100 border-black outline-green-500">
       </div>
       <div class="grid">
