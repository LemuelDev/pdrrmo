...
@section('content')
    ...
    @else
            <div class="pt-4 md:pl-4 flex flex-col lg:flex-row justify-start items-center pl-8  gap-4 lg:gap-6 max-md:pl-0">
                ...
                route('staff.only-me'))))
                }}" method="GET" class="flex pl-3 items-center justify-start gap-4 w-full max-lg:justify-center lg:w-auto max-[540px]:flex-col">
                ...
                <div class="flex lg:flex-row justify-center gap-4 items-center max-lg:justify-start lg:mt-0 max-[540px]:grid max-[540px]:grid-cols-2">
                    ...
                    <select id="restrictionsDropdown" class="text-white py-2 px-2 rounded-lg bg-red-500 hover:bg-red-500 w-full lg:w-auto md:max-w-full">
                        ...
                        <option value="{{ route('staff.public') }}">Public</option>
                        <option value="{{ route('staff.attachments') }}">Everyone</option>
                        <option value="{{ route('staff.municipality') }}">Municipality</option>
                        <option value="{{ route('staff.only-me') }}">Only Me</option>
                    </select>
                    <select id="municipalityDropdown" class="text-white py-2 px-2 rounded-lg bg-violet-600 hover:bg-violet-700 w-full max-[540px]:col-span-2 lg:w-auto max-lg:min-w-[180px] md:max-w-full">
                        ...
                        <option value="{{ route('staff.search', 'sta_cruz') }}">STACRUZ</option>
                        <option value="{{ route('staff.search', 'candelaria') }}">CANDELARIA</option>
                        <option value="{{ route('staff.search', 'masinloc') }}">MASINLOC</option>
                        <option value="{{ route('staff.search', 'palauig') }}">PALAUIG</option>
                        <option value="{{ route('staff.search', 'iba') }}">IBA</option>
                        <option value="{{ route('staff.search', 'botolan') }}">BOTOLAN</option>
                        <option value="{{ route('staff.search', 'cabangan') }}">CABANGAN</option>
                        <option value="{{ route('staff.search', 'subic') }}">SUBIC</option>
                        <option value="{{ route('staff.search', 'castillejos') }}">CASTILLEJOS</option>
                        <option value="{{ route('staff.search', 'san_antonio') }}">SAN ANTONIO</option>
                        <option value="{{ route('staff.search', 'san_felipe') }}">SAN FELIPE</option>
                        <option value="{{ route('staff.search', 'san_marcelino') }}">SAN MARCELINO</option>
                        <option value="{{ route('staff.search', 'san_narciso') }}">SAN NARCISO</option>
                        <option value="{{ route('staff.search', 'pdrrmo') }}">PDRRMO</option>
                        <option value="{{ route('staff.attachments') }}">VIEW ALL</option>
                    </select>
                 </div>
                </div>
