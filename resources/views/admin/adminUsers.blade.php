        ...
        <div class="flex-grow pt-8 h-auto px-3 2xl:max-w-[1700px] xl:max-w-[1300px] max-lg:w-full">
            ...
            <div class="pt-4 md:pl-8 flex flex-col lg:flex-row justify-start items-center gap-4 lg:gap-6 max-md:pl-0">
                ...
                <select id="municipalityDropdown" class="text-white py-2 px-2 rounded-lg bg-violet-600 hover:bg-violet-700 w-full max-[540px]:col-span-2 lg:w-auto max-lg:max-w-[250px] max-lg:mx-auto">
                    ...
                    <option value="{{ route('admin.specificUsers', 'sta_cruz') }}">STACRUZ</option>
                    <option value="{{ route('admin.specificUsers', 'candelaria') }}">CANDELARIA</option>
                    <option value="{{ route('admin.specificUsers', 'masinloc') }}">MASINLOC</option>
                    <option value="{{ route('admin.specificUsers', 'palauig') }}">PALAUIG</option>
                    <option value="{{ route('admin.specificUsers', 'iba') }}">IBA</option>
                    <option value="{{ route('admin.specificUsers', 'botolan') }}">BOTOLAN</option>
                    <option value="{{ route('admin.specificUsers', 'cabangan') }}">CABANGAN</option>
                    <option value="{{ route('admin.specificUsers', 'subic') }}">SUBIC</option>
                    <option value="{{ route('admin.specificUsers', 'castillejos') }}">CASTILLEJOS</option>
                    <option value="{{ route('admin.specificUsers', 'san_antonio') }}">SAN ANTONIO</option>
                    <option value="{{ route('admin.specificUsers', 'san_felipe') }}">SAN FELIPE</option>
                    <option value="{{ route('admin.specificUsers', 'san_marcelino') }}">SAN MARCELINO</option>
                    <option value="{{ route('admin.specificUsers', 'san_narciso') }}">SAN NARCISO</option>
                    <option value="{{ route('admin.specificUsers', 'pdrrmo') }}">PDRRMO</option>
                    <option value="{{ route('admin.users') }}">VIEW ALL</option>
                </select>
